...
<div id="content">
    ...
    <?php echo form_open('form/setting/new'); ?>
	<table class="setdata">
    ...
    ?>
		...
		<tr><th>사용필드 설정<br><a href="data_view.php" class="info">data_view.php에 표시되는 사용필드설정</a></th>
            <td>
                <?php
		...
		<tr><th>리스트 표시항목<br><a href="data_list.php" class="info">data_list.php에 표시되는 표시항목</a></th>
            <td>
                <?php
                foreach ($field_list->result() as $row)
                {
		...
		<tr><td rowspan=5 class="category">SMS설정</td><th>신청자에게 문자보내기</th><td><input type="radio" name="smsok1" value="1" checked>YES <input type="radio" name="smsok1" value="0">NO</td>
		<tr><th>발신번호</th><td><input type="text" name="smsnumber1" value=""></td></tr>
		<tr><th>문자내용</th><td><textarea name="smstext1" maxlength="80" style="width:100%;">[NAME]님대학생캠프신청을환영합니다-[PAYMENTMSG]</textarea></td></tr>
		<tr><th>관리자에게 문자보내기</th><td><input type="radio" name="smsok2" value="1" checked>YES <input type="radio" name="smsok2" value="0">NO<br>관리자 연락처 : <input type="text" name="smsnumber2"></td></tr>
		<tr><th>문자내용</th><td><textarea name="smstext2" maxlength="80" style="width:100%;"></textarea><br>
		...
		<tr><td rowspan=7 class="category">이메일설정</td><th>신청자에게 이메일보내기</th><td><input type="radio" name="mailok1" value="1" checked>YES <input type="radio" name="mailok1" value="0">NO</td></tr>
		<tr><th>발신정보</th><td>이름: <input type="text" name="mailname1" value=""> 이메일: <input type="text" name="mailmail1" value=""></td></tr>
		...
		<tr><th>이메일 본문내용</th><td><textarea name="mailtext1" maxlength="80" style="width:100%;"></textarea></td></tr>
		<tr><th>관리자에게 이메일보내기</th><td><input type="radio" name="mailok2" value="1" checked>YES <input type="radio" name="mailok2" value="0">NO<br>관리자 이메일 : <input type="text" name="mailmail2"></td></tr>
		<tr><th>이메일 탬플릿 선택</th><td><select><option>참가신청 관리자 회신</option><option>대학생캠프 문의답변 메일</option><option>마음수련 뉴스레터</option></select></td></tr>
		<tr><th>이메일 본문내용</th><td><textarea name="mailtext2" maxlength="80" style="width:100%;"></textarea></td></tr>
		
		
		<tr><td rowspan=2 class="category">결제설정</td><th>결제기능이용</th><td><input type="checkbox" name="ispay" value="1"> 결제기능을 사용합니다<br><span class="info">* 결제기능을 사용하지 않는 참가신청폼: 지역센타방문예약 / 교원 생활 연수</span></td></tr>
		<tr><th>입금계좌설정</th><td><input type="text" name="payaccount"><br><span class="info">* 참가신청폼은 결제가 연동되어 있으며, 무통장입금시 해당계좌가 표시됩니다.</span></td></tr>
